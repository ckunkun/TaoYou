...
public class HttpTaskValues {
  ...
  private static final String HTTP = "http://api.xjtmjoy.com:8062/app/";//正式域名

  //  支付的第二种方式
  public static final String API_POST_GAME_PREORDER_SECOND = "http://api.xjtmjoy.com:8062/old/h5/pay/preOldOrderNoSdk.shtml";//游戏充值订单

  //private static final String HTTP = "http://api.itoyo.cn:8081/app/";//测试域名
  /*******************************用户信息********************************/
  public static final String API_POST_GETREGTELCODE = HTTP + "passport/pf/getRegTelCode.shtml";
  //1.1.1获取手机注册验证码
  ...
  public static final String API_POST_GETRESETTELCODE = HTTP + "passport/pf/getResetTelCode.shtml";
  //1.1.4找回密码->获取手机验证码
  public static final String API_POST_RESETBYTEL = HTTP + "passport/pf/resetByTel.shtml";

  //1.1.5找回密码->手机
  public static final String API_POST_USERINFO = HTTP + "myuser/info.shtml";//1.5.1 我的用户信息接口
  /*******************************支付宝********************************/
  public static final String API_POST_ALIPAY_GETAUTHPARAMS =
          HTTP + "passport/alipay/getAuthParams.shtml";//1.4.1 获取授权参数信息接口
  public static final String API_POST_ALIPAY_LOGIN = HTTP + "passport/alipay/login.shtml";
  //1.4.2 支付宝登陆接口
  public static final String API_POST_ALIPAY_PREWAPCOINORDER =
          HTTP + "pay/alipay/preWapCoinOrder.shtml";//1.4.3 创建手机网站淘币预订单
  public static final String API_POST_ALIPAY_PREWAPGAMEORDER =
          HTTP + "pay/alipay/preWapGameOrder.shtml";//1.4.4 创建游戏预支付订单
  public static final String API_POST_ALIPAY_CALLBACK = HTTP + "pay/alipay/callback.shtml";
  //1.4.5 支付宝回调
  public static final String API_POST_GAME_PREORDER = HTTP + "pay/yijie/handleOrder.shtml";//游戏充值订单


  //  /微信
  public static final String WECHAT_PAY_GAME = "http://api.xjtmjoy.com:8062/sdk/h5/pay/wechat/preWapGameOrder.shtml";
  //淘币充值
  public static final String WECHAT_PAY_COIN = "http://api.xjtmjoy.com:8062/sdk/h5/pay/wechat/preTaoYouOrder.shtml";
  //微信充值查询
  public static final String WECHAT_FIND_IS_PAY = "http://api.xjtmjoy.com:8062/sdk/h5/pay/wechat/reloadToOrderOfTao.shtml";
  ...
  // 获取老手机号验证码
  public static final String API_POST_SAFE_GETCODE = HTTP + "passport/pf/getVerifyTelCode.shtml";

  public static final String API_POST_SAFE_VERIFYCODE =
          HTTP + "passport/pf/verifyOldTel.shtml";
  public static final String API_POST_SAFE_GETNEWCODE =
          HTTP + "passport/pf/getBindTelCode.shtml";
  public static final String API_POST_SAFE_SETTEL = HTTP + "passport/pf/userUpdateByTel.shtml";
